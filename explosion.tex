...
%conversely, a symbolic analysis can help a type checker for instance by providing context-sensitive properties over a variable that would rule out certain type errors, improving the precision of the type checker.
