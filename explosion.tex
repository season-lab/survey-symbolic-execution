...
int bar(int x, int y) {
 if (x < 5 && y >= 6) 
  ...
  \begin{subfigure}{.33\textwidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{(a) Source code of function {\tt bar}. (b) CFG for the function {\tt bar}. Solid edges and nodes shows the path taken by the concolic execution for {\tt x = 2} and {\tt y = 6}. These input values have been randomly chosen. (c) Concolic execution for {\tt x = 1} and {\tt y = 6}. These input values have been obtained using a constraint solver, after negating the path constraints of node B in the function {\tt bar}.}
