...
\begin{figure}[t]
  ...
  \begin{tabular}{| l || l |}
    ...
    Fitness function & {\em Prioritize paths based on a fitness function} \\ & \cite{XTD-DSN09,CS-CACM13,XTD-DSN09} \\
...
int bar(int x, int y) {
  ...
  \begin{subfigure}{.33\textwidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{(a) Source code of function {\tt bar}. (b) CFG for the function {\tt bar}. Solid edges and nodes shows the path taken by the concolic execution when {\tt x = 2} and {\tt y = 6}. These input values have been randomly chosen. (c) Concolic execution when {\tt x = 1} and {\tt y = 6}. These input values have been obtained using a constraint solver, after negating the path constraints of node B in the function {\tt bar}.}
