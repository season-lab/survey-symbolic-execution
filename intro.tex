...
The supplementary material addresses further challenges arising in applying symbolic execution to binary code, discusses some prominent applications of symbolic execution, and includes tables listing some prominent symbolic execution tools and techniques.
}
}
