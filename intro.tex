...
Symbolic execution has been the focus of a vast body of literature. As of August 2017, Google Scholar reports 742 articles that include the exact phrase ``symbolic execution'' in the title. Prior to this survey, other authors have contributed technical overviews of the field. Among them, we cite \cite{PV-JSTTT09,CS-CACM13}. \cite{CHEN20131758} focuses on the more specific setting of automated test generation. This work provides a comprehensive and updated view of the literature, complementing the technical discussions with a number of running examples.
