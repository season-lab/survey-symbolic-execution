...
Symbolic execution has been the focus of a vast body of works. As of August 2017, Google Scholar reports over 700 articles that include the phrase ``symbolic execution'' in the title. Prior to this survey, other authors have contributed technical overviews of the field of symbolic execution. \cite{PV-JSTTT09} surveys new trends in the area [...]. \cite{CS-CACM13}. \cite{CGK-ICSE11}. This work provides a comprehensive and up-to-date review of the literature, covering several aspects that remained unaddressed in previous surveys, such as .
