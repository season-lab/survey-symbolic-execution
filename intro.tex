...
will make {\tt assert} fail. An instance of unsafe input parameters can be eventually determined by invoking a {\em model checker}~\cite{}\mynote{Add citation...} to solve the path constraints, which in this example would yield $a = 2$ and $b = 0$. 
