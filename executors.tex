...
\mytempedit{{\sc \stwoe}~\cite{CKC-TOCS12} takes a different approach to mixing symbolic and concrete execution based on the observation that one may want to explore only some components of a software stack in full, but not to care about others. {\em Selective symbolic execution} carefully interleaves concrete executions of functions with fully symbolic phases, while keeping the exploration meaningful.
