...
\noindent A fundamental idea that has been proposed in literature to cope with the above issues and make symbolic execution feasible in practice is to mix concrete and symbolic execution: this is dubbed {\em concolic execution}, where the term concolic is a portmanteau of the words ``concrete'' and ``symbolic'' (Figure~\ref{fig:concrete-symbolic}). This general principle has been explored along different angles, as described in the remainder of this section. We defer the discussion of issue~(\ref{it:smt-solver-issue}) to Section~\ref{se:constraint-solving}.
