...
A number of performance-related design principles that a symbolic execution engine should follow are  summarized in {\sc Mayhem}~\cite{MAYHEM-SP12}. Most notably:
\begin{enumerate}
...
\begin{figure}[t]
  ...
  \begin{tabular}{| l || c || l |}
    \hline      
    Symbolic engine & Paper(s) & Project URL (last retrieved: August 2016)  \\ \hline\hline
    ...
    {\sc CIVL} & \cite{CIVL-TECH14} & \url{http://vsl.cis.udel.edu/civl/}\\ % : The Concurrency Intermediate Verification Language 
