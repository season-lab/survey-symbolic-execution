...
A number\mynote{[D] why MAYHEM?}  of performance-related design principles that a symbolic execution engine should follow are  summarized in {\sc Mayhem}~\cite{MAYHEM-SP12}. Most notably:
\begin{enumerate}
