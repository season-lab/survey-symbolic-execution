...
\SetBgContents{\fcolorbox{red}{white}{\parbox{\dimexpr\linewidth+12\fboxsep-2\fboxrule}{\itshape\small If you are considering citing this survey, we would appreciate if you could use the following BibTeX entry: \href{http://goo.gl/Hf5Fvc}{http://goo.gl/Hf5Fvc}}}}
% \em\small If you are considering citing this survey, we would appreciate if you could use the following BibTeX entry: \href{http://goo.gl/Hf5Fvc}{http://goo.gl/Hf5Fvc}
\SetBgScale{1}
\SetBgColor{black}
\SetBgAngle{0}
\SetBgOpacity{1}
