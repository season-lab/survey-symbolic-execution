...
\revedit{
This survey has discussed some of the key aspects and challenges of symbolic execution, presenting the basic design principles of symbolic executors and the main optimization techniques for a broad audience. We hope it will help non-experts grasp the key inventions in this exciting line of research, inspiring further work and new ideas.
...
\revedit{
The online appendix of this manuscript presents a selection of prominent applications of symbolic execution techniques, addresses further challenges that arise when dealing with programs in binary form, and provides a list of popular symbolic engines.}
