...
%\begin{online}
\revedit{
The online appendix of this manuscript discusses a selection of prominent applications of symbolic execution techniques, addresses further challenges that arise when dealing with programs in binary form, and provides a list of popular symbolic engines.
}
%\end{online}
