...
\begin{itemize}
  \item {\tt CFGAccurate}: slow, iterative CFG recovery, mix of {\em force execution}, {\em backwards slicing}, {\em symbolic execution} to recover indirect jumps.
  \item {\tt CFGFast}: fast but inaccurate, based on a dissambler
\end{itemize}
