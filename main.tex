...
\item \cite{CGK-ICSE11} Symbolic execution for software testing in practice: preliminary assessment, 2011
\item (EMILIO) \cite{CS-CACM13} Symbolic execution for software testing: three decades later, 2013
\end{itemize}
