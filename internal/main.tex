...
\begin{itemize}
  ...
  \item (EMILIO) \cite{PV-SPIN04} Verification of Java Programs Using Symbolic Execution and Invariant Generation
  ...
  \item (DANIELE?) \cite{BITBLAZE-ICISS08}: {BitBlaze}: A New Approach to Computer Security via Binary Analysis 
  \item (EMILIO) \cite{EGL-ISSTA09} Precise Pointer Reasoning for Dynamic Test Generation
